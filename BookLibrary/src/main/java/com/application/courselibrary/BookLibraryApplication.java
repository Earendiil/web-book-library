...
public class BookLibraryApplication {
	...
	public CommandLineRunner initialCreate(BookService bookService) {
		return(args) ->{
			...
			Author author1 = new Author ("Test name", "Test desctiption");
			...
			// Create book2
			Book book2 = new Book("XYZ", "Book two name", "My second book");
			Author author2 = new Author("Second Author", "Author description two");
			...
			// Create book3 
			Book book3 = new Book("DEF", "Book three name", "My third book");
			Author author3 = new Author("Third Author", "Author description three");
			Category category3 = new Category("Technology books");
